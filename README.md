...
**v1.3.4 已发布** —— 紧急修复 v1.3.3 中窗口右侧标题栏区域仍残留灰色块的问题。现在整个标题栏区域与两侧背景完全统一，视觉上不再有断层或色块。

[查看 v1.3.4 发布说明 →](https://github.com/wolfprince12/squirrel-Panel/releases/tag/v1.3.4)

**v1.3.3** 紧急修复 v1.3.2 中侧边栏与标题栏之间的视觉断层问题。通过透明标题栏让侧边栏背景延伸至窗口顶部，整体外观恢复统一。

[查看 v1.3.3 发布说明 →](https://github.com/wolfprince12/squirrel-Panel/releases/tag/v1.3.3)
